...
//
//
            Produkt Gansbraeu = new Produkt("Gansbräu Rotbier",
                    24.00,
                    5.00,
                    "Vollbier",
                    0.5,
                    "Zartbitterschokolade, Kandiszucker, Trockenfrüchte",
                    "feine Röstbittere im Nachtrunk",
                    "Hochzeit, Seele baumeln lassen, Kamingespräch, TV Abend ",
                    "Wasser, Gerstenmalz, Hopfen",
                    "Dieses Rotbier weist neben seiner schönen, klaren Kupferfarbe und dem feinporigen Schaum eine kräftige" +
                    " Malzaromatik nach Karamellbonbon und Zartbitterschokolade auf. Weich im Antrunk, verteilt sich dieses Rotbier" +
                            ...
                            " am Ende ist wahrnehmbar und bildet einen sehr guten Ausgleich zu der malzigen Süße.");
